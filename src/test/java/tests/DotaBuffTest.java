...
public class DotaBuffTest extends ConfigDotaBuff {
    ...
    void byOneValueTest(String heroName) {
    ...
    void byTwoValueTest(String heroName, String typeOfHero) {
        dotaBuffPage.openPage()
                .setHeroName(heroName)
                .checkResultTypeHero(typeOfHero);
    }

    static Stream<Arguments> byThreeValueTest() {
        return Stream.of(
    ...
    void byThreeValueTest(String heroName, List<String> talents) {
        dotaBuffPage.openPage()
                .setHeroName(heroName)
                .clickHeroName()
                .abilitiesButton()
